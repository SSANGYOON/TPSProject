...
void ULagCompensationComponent::ServerScoreRequest_Implementation(ATPSCharacter* HitCharacter, const FVector_NetQuantize& TraceStart, const FVector_NetQuantize& HitLocation, float HitTime)
{
